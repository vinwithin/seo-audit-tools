...
class seoAudit:
    def __init__(self, url, position, amp, target_keyword, moz_api_client, moz_api_key, cek, pagespeed_api_key):
        self.url = url
    ...
    def perform_seo_checks(self):
        ...
        #     print(f"Request timed out for URL: {self.url}")
        #     return
