...
user_website = "https://www.google.com/"
# input('Type your web page\'s URL\n')
...
#     exit()
# 4288dc40-353c-11ef-a2b4-0182fe223637?

# create a free account on https://moz.com/products/api/pricing
# get your API key up to 2,500 rows per month
# or upgrade to premium
# bW96c2NhcGUtNHVVQTVsTExuYTpZUTZqSnVCWjFOQ0FPMktjQ1p1RkFkclpybURyMXlpNQ==

moz_api_client = "mozscape-4uUA5lLLna"
# input("Type the Moz Client ID\n")  # Ex. mozscape-229f6d2c36
...
mobile_api_key = "AIzaSyBTVMHCioVHlbspDabq-4NYcgVMwwGH2sk"
# input("Type the MobileFriendlyTest API Key ID\n")  # Ex. AIzaSyABgSO4Z0p-zEjnzHIRRWjS5fEBNWal7-s
...
# there are limitations have to take into consideration
pagespeed_api_key = "AIzaSyBTVMHCioVHlbspDabq-4NYcgVMwwGH2sk"
# input("Type the PageSpeed API Key ID\n")  # Ex. AIzaSyAVDI6VTjyzpG1KrGrCMuM15Dw7BH1g3zE
# if not pagespeed_api_key:
#     print('Invalid PageSpeed API Key')
#     exit()
# AIzaSyBTVMHCioVHlbspDabq-4NYcgVMwwGH2sk
...
for website in websites:
    ...
    #                      websites[website]['amp'], target_keyword, 
    #                      moz_api_client, moz_api_key, mobile_api_key,
    #                      pagespeed_api_key)
    seo_audit = seoAudit(websites[website]['url'], websites[website]['position'],
                         websites[website]['amp'], target_keyword, 
                         moz_api_client, moz_api_key, cek, pagespeed_api_key)
